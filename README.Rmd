...
I show some examples how consistent names of variable can be really powerful because it's easier to automate things and use [Regular Expressions](https://stringr.tidyverse.org/articles/regular-expressions.html).  
